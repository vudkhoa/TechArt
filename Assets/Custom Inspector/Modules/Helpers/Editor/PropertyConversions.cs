...
namespace CustomInspector.Extensions
{
    public static class PropertyConversions
    {
        ...
        /// 
        /// </summary>
        /// <returns>removes underscores, starts uppercase, adds spaces, removes compiler-addons like ..k__Backing Field </returns>
        public static string NameFormat(string name)
        {
            ...
            // remove backing field info | <foo>k_Backing Field -> foo
            if (name[0] == '<'
                && name.Length > "<>k__BackingField".Length
                && name[(^">k__BackingField".Length)..] == ">k__BackingField")
            {
                name = name[1..^">k__BackingField".Length];
            }

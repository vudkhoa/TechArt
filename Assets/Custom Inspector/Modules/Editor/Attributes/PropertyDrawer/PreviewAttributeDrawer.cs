...
namespace CustomInspector.Editor
{
    ...
    public class PreviewAttributeDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            {
                DrawProperties.DrawPropertyWithMessage(position, label, property, $"Preview for {PropertyConversions.NameFormat(property.name)} not supported (only object-references allowed)", MessageType.Error);
                return;
            }

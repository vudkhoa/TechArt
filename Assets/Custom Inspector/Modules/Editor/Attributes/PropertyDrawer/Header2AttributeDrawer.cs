...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    public class Header2AttributeDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            //style
            GUIStyle stylePreset = t.bold ? EditorStyles.boldLabel : EditorStyles.label;
            GUIStyle titleStyle = new(stylePreset)
            {
                fontSize = t.fontSize,

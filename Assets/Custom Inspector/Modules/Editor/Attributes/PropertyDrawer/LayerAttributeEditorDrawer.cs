        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (!string.IsNullOrEmpty(l.requiredName))
            {
                ...
                else
                {
                    ...
                    DrawProperties.DrawMessageField(errorRect, $"{PropertyConversions.NameFormat(property.name)}'s value does not match the code's: {l.requiredName}", MessageType.Warning);
